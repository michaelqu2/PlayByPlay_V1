...
class _QuestionLongTestPageState extends State<QuestionLongTestPage> {
  final List<Map<String, String>> data = [
    ...
    {"Category": "", "Test/Measurement": "Weight (lbs):"},
    {
      ...
      "Test/Measurement": "Max Bench Press (lbs)"
    },
    ...
    {"Category": "Flexibility", "Test/Measurement": "Sit and Reach Test"},
    {
      ...
      "Test/Measurement": "One-Leg Balance Test"
    },
    {
      "Category": "Reaction Time Test",
      "Test/Measurement": "Hand Reaction Time."
    },
    ...
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          ...
          title: Text('Physical Test', style: TextStyle(color: Colors.white)),
        ),
        body: Column(
          children: [
            Expanded(
            ...
            ElevatedButton(
              ...
              onPressed: () {
                ...
                Navigator.pop(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const QuestionLongChoicePage()));
              },
              child: Text(
                'Save',
                style: TextStyle(fontSize: 25),
              ), // The child parameter should be here
            ),
            SizedBox(
              height: 20,
            )
  ...
  void _saveData() async {
    ...
    List<String> testList =
        data.map((row) => row['Test/Measurement']!).toList();
    await prefs.setStringList('Long Test', testList);

    // Save the test inputs
    List<String> testInputList =
        _controllers.values.map((controller) => controller.text).toList();
...
class DataSheet extends StatelessWidget {
  ...
  void _showInstructions(BuildContext context, String test) {
    final instructions = {
      ...
      "Squats Test":
          "Perform as many squats as possible within a set time frame.",
      "Planks Test":
          "Hold a plank position for as long as possible while maintaining proper form.",
      "Running Performance":
          "Complete a running test, such as a timed mile or sprint, and record your performance.",
      "Body Composition (BIA)":
          "Use a body composition analyzer to measure your body fat percentage and muscle mass.",
      "Reaction Time Test":
          "Use a reaction time tool to measure the time it takes for you to respond to a visual or auditory stimulus.",
      "Agility T-Test":
          "Perform the T-test, running between cones arranged in a 'T' shape as quickly as possible.",
      "Illinois Agility Test":
          "Run through an obstacle course of cones laid out in a specific pattern to assess agility.",
      "Lateral Change of Direction Test":
          "Move side-to-side as quickly as possible between markers in this test of lateral agility.",
      "Online Reaction Time Tests":
          "Complete an online test to measure your reaction time to visual or auditory cues.",
      "Jump and Landing Test":
          "Perform a vertical or broad jump, then focus on landing with good balance and control.",
      "One-Leg Stand Test":
          "Stand on one leg for as long as possible to assess your balance and stability.",
      "Cooper Test":
          "Run as far as possible in 12 minutes; typically performed on a track or treadmill.",
      "One-Rep Max":
          "Perform a single maximum lift for a given exercise (e.g., bench press, squat).",
      "Handgrip Strength":
          "Use a handgrip dynamometer to measure your grip strength.",
      "Vertical Jump":
          "Perform a vertical jump and measure the height you reach.",
      "Sit and Reach Test":
          "Sit with your legs extended and reach as far forward as possible to see if you can touch toe",
      "Joint Range of Motion":
          "Use a goniometer or similar tool to measure the range of motion of a joint (e.g., knee, elbow).",
      "Functional Movement Screen":
          "Perform a series of functional movements to assess mobility, stability, and coordination.",
      "Standing Broad Jump":
          "Jump as far forward as possible from a standing position.",
      "Wall Sit Test":
          "Hold a seated position with your back against the wall for as long as possible.",
      "5-10-5 Shuttle Run":
          "Run 5 yards, touch the line, run back 10 yards, and then return 5 yards as fast as possible.",
      "Talk Test":
          "Perform aerobic exercise to assess how long you can talk without stopping",
      "HIIT Performance":
          "Complete a high-intensity interval training (HIIT) session and measure your performance (e.g., number of intervals completed, intensity).",
    };
