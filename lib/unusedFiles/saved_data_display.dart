  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Prediction', style: TextStyle(color: Colors.white)),
          ...
          : savedDataMap.isEmpty
              ? Center(child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 20),
                  Text('No saved data found', style: TextStyle(fontSize: 20)),
                  SizedBox(height: 100),
                ],
              ))
                        ...
                        Column(
                          ...
                          children: [
                            _buildContainer(
                              title: 'Final Sports',
                              description:
                                  "Sports that best match the user's profile.",
                            ...
                            _buildContainer(
                              ...
                              description:
                                  "Sports that the user personally prefers the most.",
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 8),
          if (child != null) child,
          // Add this line to include the child if provided
        ],
      ),
    );
  }
              ...
              RadarChartData(
                ...
                getTitle: (index, angle) {
                  ...
                  return RadarChartTitle(
                      text: categories.length > index ? categories[index] : '');
                },
              ),
            ),
          ),
